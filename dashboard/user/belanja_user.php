...
<head>
    <meta charset="UTF-8">
    <title>Belanja UMKM | Desa Pancasila</title>
...
<section class="hero-bg py-24 text-white">
    <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-gray-200 max-w-2xl mx-auto">
            Dukung produk lokal dan ekonomi masyarakat Desa Pancasila
        </p>
    </div>
</section>
            ...
            <?php if ($umkm && $umkm->num_rows > 0): ?>
                <?php while ($u = $umkm->fetch_assoc()): ?>
                    <article class="bg-white rounded-xl shadow-lg overflow-hidden hover:-translate-y-1 hover:shadow-xl transition">
                        ...
                        <?php if (!empty($u['foto'])): ?>
                            <img
                                src="../../uploads/umkm/<?= htmlspecialchars($u['foto']) ?>"
                                alt="<?= htmlspecialchars($u['nama_usaha']) ?>"
                        ...
                        <div class="p-6">
                            <span class="text-sm text-gray-500">
                                Pemilik: <?= htmlspecialchars($u['pemilik']) ?>
                            </span>
                            ...
                            <p class="text-gray-600 mb-4">
                                <?= htmlspecialchars(substr($u['deskripsi'], 0, 130)) ?>...
                            </p>
