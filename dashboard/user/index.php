...
// BUKAN USER → TENDANG KE DASHBOARD SESUAI ROLE
    ...
    <section id="beranda" class="hero-bg min-h-screen flex items-center justify-center text-center text-white py-20">
        <div class="container mx-auto px-4 max-w-3xl">
            ...
            <div class="flex flex-col md:flex-row gap-4 justify-center">
                ...
                <button onclick="openLoginModal('user')" class="bg-white bg-opacity-20 text-white px-8 py-3 rounded-lg font-semibold hover:bg-opacity-30 backdrop-blur transition">
                    Jelajahi Sekarang
                </button>
            </div>
        </div>
    ...
    <section id="peta" class="pt-32 pb-20 bg-gradient-to-br from-blue-50 to-blue-100">
        <div class="container mx-auto px-4">
            ...
            <div class="text-center mt-8">
                <a href="../../dashboard/user/lokasi_user.php" class="inline-block btn-accent text-white px-8 py-3 rounded-lg font-semibold hover:shadow-lg transition">
                    Lihat Peta Lengkap
                </a>
            </div>
        </div>
